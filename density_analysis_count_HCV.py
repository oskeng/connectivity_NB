#!/usr/bin/python3.11
#
# Computes r.neighbors for HCV forest (excluding continuity forest)
# #
...
input = 'out_input_HCV_final@HCV_kskog'
output_250 = 'output_HCV_250m_v2'
output_500 = 'output_HCV_500m_v2'
output_1000 = 'output_HCV_1000m_v2'
...
Module("r.neighbors", flags='c', overwrite=True, input=input,
       output=output_250, size=51, method='count', memory=60000)
